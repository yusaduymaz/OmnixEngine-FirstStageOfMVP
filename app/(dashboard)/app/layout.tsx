  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 border-r border-orange-100/20 bg-slate-50 flex flex-col p-4 z-50">
      ...
      <div className="mt-auto pt-6 border-t border-slate-200 space-y-1">
        ...
        <Link href="/app/support" className="flex items-center gap-3 px-4 py-2 text-slate-500 hover:text-slate-900 text-sm rounded-xl hover:bg-slate-100 transition-colors">
          <IconHelp />
          <span>Destek</span>
        </Link>
